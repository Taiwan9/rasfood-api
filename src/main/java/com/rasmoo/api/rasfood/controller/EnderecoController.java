...
public class EnderecoController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Endereco> consultaPorCpfEmail(@PathVariable("id") final Integer id){
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<Endereco> atualizar(@PathVariable("id") final Integer id, @RequestBody final Endereco endereco) throws JsonMappingException, JsonMappingException {
